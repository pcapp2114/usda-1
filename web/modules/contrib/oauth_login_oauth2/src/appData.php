  ...
  */
  public static function app_list($temp) {
    ...
    elseif ($temp == 'oidc_apps') {
      ...
      return [
        Markup::create('<a class="mo-apps-table-text" href="configure_app/aws" > <img class="img-mo-logo " alt="AWS Cognito" src="' . $url_path . '/cognito.png"><br> AWS Cognito </a>'),
  ...
  /**
   * Displays app specific setup guides.
   *
   * @return array
  ...
  public static function app_guides($app_name) {
    $guides = [
      ...
      'aws' => ['setup' => 'https://plugins.miniorange.com/setup-guide-to-configure-aws-cognito-with-drupal', 'video' => ''],
    ];
  ...
  /**
   * Displays app specific endpoints and scope.
   *
   * @return array
   *   Returns array of scope and endpoints of app.
   */
  public static function endpoints($app_name) {
    $endpoints = [
      ...
      'linkedin' => ['Scope: ' => 'openid profile email', 'Authorization Endpoint: ' => 'https://www.linkedin.com/oauth/v2/authorization', 'Access Token Endpoint: ' => 'https://www.linkedin.com/oauth/v2/accessToken', 'Userinfo Endpoint: ' => 'https://api.linkedin.com/v2/userinfo'],
      ...
      'aws' => ['Scope: ' => 'openid', 'Authorization Endpoint: ' => 'https://{cognito-app-domain}/oauth2/authorize', 'Access Token Endpoint: ' => 'https://{cognito-app-domain}/oauth2/token', 'Userinfo Endpoint: ' => 'https://{cognito-app-domain}/oauth2/userInfo'],
    ];
