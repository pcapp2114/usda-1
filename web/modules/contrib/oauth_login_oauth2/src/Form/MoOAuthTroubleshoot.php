...
class MoOAuthTroubleshoot extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['markup_custom_troubleshoot']['miniorange_oauth_client_enable_logging'] = [
      ...
      '#description' => t('Enabling this checkbox will add loggers under the ').'<a href="' . Url::fromRoute('dblog.overview', ['type' => 'oauth_login_oauth2'])->toString() . '" target="_blank">'.t('Reports').'</a>'.t(' section'),
      '#suffix' => '<br>',
      '#prefix' => '<hr>',
    ];
    ...
    $form['markup_custom_export_logs']['miniorange_oauth_client_enable_logging'] = [
      ...
      '#prefix' => '<hr> '.t('Click on the button below to download module related logs.').'<br><br>',
    ];
