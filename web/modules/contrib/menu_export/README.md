 ...
 * https://www.drupal.org/project/menu_migration
...
* `drush menu_export:import` for triggering the import of menu items after config import.
* `drush menu_export:export` for triggering the export of menu items before config export.
