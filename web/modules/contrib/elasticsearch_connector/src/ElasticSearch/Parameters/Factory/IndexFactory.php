...
class IndexFactory {
  ...
  public static function bulkIndex(IndexInterface $index, array $items) {
    ...
    $event = $dispatcher->dispatch($buildIndexParamsEvent, BuildIndexParamsEvent::BUILD_PARAMS);
  ...
  public static function mapping(IndexInterface $index) {
    ...
    $event = $dispatcher->dispatch($prepareIndexMappingEvent, PrepareIndexMappingEvent::PREPARE_INDEX_MAPPING);
