...
namespace Drupal\Tests\group\Unit {
  ...
  class OperationProviderTest extends UnitTestCase {
    ...
    public function testGetOperations($expected, $plugin_id, GroupRelationTypeInterface $definition, $installed, $field_ui) {
      ...
      $module_handler->hasImplementations('entity_operation', 'field_ui')->willReturn(TRUE);
      $module_handler->invoke('field_ui', 'entity_operation', [$group_relationship_type])->willReturn(['bar' => []]);
      ...
      $storage->load('foobar')->willReturn($group_relationship_type);
