...
class LatestRevisionCheck extends ContentModerationLatestRevisionCheck implements AccessInterface {
  ...
  protected function checkGroupAccess(ContentEntityInterface $entity, AccountInterface $account) {
    ...
    $group_relationship_types = $this->entityTypeManager->getStorage('group_content_type')->loadByPluginId($plugin_id);
    ...
    foreach ($group_relationships as $group_relationship) {
      ...
      $access->addCacheableDependency($group_relationship);
