...
class __TwigTemplate_65985ab7b60c8db37b04b883e5dada80 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
        // line 24
        if ((( !twig_test_empty(($context["title"] ?? null)) || ($context["required"] ?? null)) || ($context["form_optional_label"] ?? null))) {
            // line 25
            echo "<label";
            ...
            echo " ";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(((( !($context["required"] ?? null) && ($context["form_optional_label"] ?? null))) ? (t("<span class=\"usa-hint\">(optional)</span>")) : ("")));
            echo "</label>";
        }
    }
    ...
    {
        return array (  50 => 25,  48 => 24,  45 => 23,  43 => 20,  42 => 19,  41 => 18,  40 => 17,  39 => 16,);
    }
...
{% if title is not empty or required or form_optional_label -%}
  <label{{ attributes.addClass(classes) }}>{{ title }} {{ not required and form_optional_label? '<span class=\"usa-hint\">(optional)</span>'|t : ''  }}</label>
{%- endif %}
", "themes/contrib/uswds/templates/form/form-element-label.html.twig", "/Users/jtoomer/Sites/nass/nass_www/web/themes/contrib/uswds/templates/form/form-element-label.html.twig");
    }
    
    public function checkSecurity()
    {
        static $tags = array("set" => 16, "if" => 24);
        static $filters = array("escape" => 25, "t" => 25);
